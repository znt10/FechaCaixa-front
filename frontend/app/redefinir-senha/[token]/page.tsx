              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-theme-border bg-theme-card py-3 pl-11 pr-12 text-theme-text-title outline-none transition placeholder:text-theme-text-sub focus:border-theme-acao focus:ring-2 focus:ring-theme-acao/20"
                    required
                  />
                  <button
                    type="button"
