      ...
      <aside className="hidden w-1/2 items-center justify-center bg-theme-header px-10 lg:flex">
        <div className="w-full max-w-lg">
          <div className="mb-10 flex items-center gap-4">
            <MarcaFechaCaixa className="h-16 w-16" />
            <h1 className="text-5xl font-bold tracking-tight">FechaCaixa</h1>
          </div>

          <div className="space-y-4 border-l-4 border-theme-acao pl-6">
            <p className="text-sm font-semibold uppercase tracking-wide text-theme-acao">
      ...
      <main className="flex min-w-0 w-full items-center justify-center px-5 py-10 sm:px-8 lg:w-1/2">
        <div className="w-full max-w-md">
          <header className="mb-8 text-center">
            <div className="mx-auto mb-4 flex h-11 w-11 items-center justify-center rounded-lg bg-theme-acao">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-theme-border bg-theme-card py-3 pl-11 pr-4 text-theme-text-title outline-none transition placeholder:text-theme-text-sub focus:border-theme-acao focus:ring-2 focus:ring-theme-acao/20"
                  required
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={enviando}
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-theme-acao py-3.5 text-sm font-semibold text-white shadow-md transition hover:bg-theme-acao-hover active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
            >
            ...
            <Link
              href="/login"
              className="mx-auto inline-flex items-center gap-2 text-theme-text-sub transition-all hover:text-theme-acao group"
            >
